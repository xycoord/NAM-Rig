...
// Target loudness (dB) for Normalized output mode. -18 is the classic
// mixing reference; trimming it by ear against bypass makes EVERY
// well-tagged model land at bypass level at once.
inline const juce::ParameterID normTarget{"norm_target", 1};
